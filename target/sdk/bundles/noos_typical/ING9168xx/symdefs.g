...
kv_remove_all = 0x0200b331;
kv_value_modified = 0x0200b361;
kv_value_modified_of_key = 0x0200b37d;
kv_visit = 0x0200b389;
l2cap_add_event_handler = 0x0200b419;
l2cap_can_send_packet_now = 0x0200b429;
l2cap_create_le_credit_based_connection_request = 0x0200b5ed;
l2cap_credit_based_send = 0x0200b735;
l2cap_credit_based_send_continue = 0x0200b761;
l2cap_disconnect = 0x0200b7dd;
l2cap_get_le_credit_based_connection_credits = 0x0200b9c1;
l2cap_get_peer_mtu_for_local_cid = 0x0200b9dd;
l2cap_init = 0x0200be09;
l2cap_le_send_flow_control_credit = 0x0200befd;
l2cap_max_le_mtu = 0x0200c1f9;
l2cap_register_packet_handler = 0x0200c321;
l2cap_register_service = 0x0200c32d;
l2cap_request_can_send_now_event = 0x0200c43d;
l2cap_request_connection_parameter_update = 0x0200c457;
l2cap_send_echo_request = 0x0200c925;
l2cap_unregister_service = 0x0200ca05;
le_device_db_add = 0x0200ca5d;
le_device_db_find = 0x0200cb35;
le_device_db_from_key = 0x0200cb61;
le_device_db_iter_cur = 0x0200cb69;
le_device_db_iter_cur_key = 0x0200cb6d;
le_device_db_iter_init = 0x0200cb71;
le_device_db_iter_next = 0x0200cb79;
le_device_db_remove_key = 0x0200cb9f;
ll_adjust_conn_peer_tx_power = 0x0200cbcd;
ll_aes_encrypt = 0x0200cbf9;
ll_config = 0x0200cc6d;
ll_free = 0x0200ccab;
ll_get_capabilities = 0x0200ccb5;
ll_get_heap_free_size = 0x0200ccd1;
ll_get_states = 0x0200cce1;
ll_hint_on_ce_len = 0x0200cd9d;
ll_legacy_adv_set_interval = 0x0200cdd5;
ll_malloc = 0x0200cde5;
ll_register_hci_acl_previewer = 0x0200cefd;
ll_scan_set_fixed_channel = 0x0200cf61;
ll_set_adv_access_address = 0x0200d179;
ll_set_adv_coded_scheme = 0x0200d185;
ll_set_conn_acl_report_latency = 0x0200d1bd;
ll_set_conn_coded_scheme = 0x0200d1ed;
ll_set_conn_latency = 0x0200d219;
ll_set_conn_tx_power = 0x0200d249;
ll_set_def_antenna = 0x0200d285;
ll_set_initiating_coded_scheme = 0x0200d2a5;
ll_set_max_conn_number = 0x0200d2b1;
ll_set_tx_power_range = 0x0200d345;
nibble_for_char = 0x02020041;
platform_calibrate_rt_clk = 0x020200d9;
platform_call_on_stack = 0x0200303f;
platform_cancel_us_timer = 0x020200dd;
platform_config = 0x020200f1;
platform_controller_run = 0x0202022d;
platform_create_us_timer = 0x02020261;
platform_delete_timer = 0x02020275;
platform_enable_irq = 0x0202027d;
platform_get_gen_os_driver = 0x020202b1;
platform_get_link_layer_interf = 0x020202bd;
platform_get_task_handle = 0x020202c5;
platform_get_timer_counter = 0x020202dd;
platform_get_us_time = 0x020202e1;
platform_get_version = 0x020202e5;
platform_hrng = 0x02020301;
platform_init_controller = 0x02020309;
platform_os_idle_resumed_hook = 0x02020325;
platform_patch_rf_init_data = 0x02020329;
platform_post_sleep_processing = 0x02020335;
platform_pre_sleep_processing = 0x0202033b;
platform_pre_suppress_ticks_and_sleep_processing = 0x02020341;
platform_printf = 0x02020345;
platform_raise_assertion = 0x02020359;
platform_rand = 0x0202036d;
platform_read_info = 0x02020371;
platform_read_persistent_reg = 0x020203a1;
platform_reset = 0x020203c1;
platform_rt_rc_auto_tune = 0x020203d5;
platform_rt_rc_auto_tune2 = 0x020203dd;
platform_rt_rc_tune = 0x0202043d;
platform_set_abs_timer = 0x02020469;
platform_set_evt_callback = 0x0202046d;
platform_set_evt_callback_table = 0x02020481;
platform_set_irq_callback = 0x0202048d;
platform_set_irq_callback_table = 0x020204a9;
platform_set_rf_clk_source = 0x020204b5;
platform_set_rf_init_data = 0x020204c1;
platform_set_rf_power_mapping = 0x020204cd;
platform_set_timer = 0x020204d9;
platform_shutdown = 0x020204dd;
platform_switch_app = 0x020204e1;
platform_trace_raw = 0x020204f9;
platform_write_persistent_reg = 0x02020511;
printf_hexdump = 0x02020545;
reverse_128 = 0x020208c9;
reverse_24 = 0x020208cf;
reverse_256 = 0x020208d5;
reverse_48 = 0x020208db;
reverse_56 = 0x020208e1;
reverse_64 = 0x020208e7;
reverse_bd_addr = 0x020208ed;
reverse_bytes = 0x020208f3;
sm_add_event_handler = 0x02020c51;
sm_address_resolution_lookup = 0x02020da9;
sm_authenticated = 0x02021161;
sm_authorization_decline = 0x0202116f;
sm_authorization_grant = 0x0202118f;
sm_authorization_state = 0x020211af;
sm_bonding_decline = 0x020211c9;
sm_config = 0x0202161d;
sm_config_conn = 0x02021659;
sm_encryption_key_size = 0x02021813;
sm_just_works_confirm = 0x02021dc5;
sm_le_device_key = 0x02022119;
sm_passkey_input = 0x020221af;
sm_private_random_address_generation_get = 0x02022575;
sm_private_random_address_generation_get_mode = 0x0202257d;
sm_private_random_address_generation_set_mode = 0x02022589;
sm_private_random_address_generation_set_update_period = 0x020225b1;
sm_register_external_ltk_callback = 0x020226ed;
sm_register_oob_data_callback = 0x020226f9;
sm_request_pairing = 0x02022705;
sm_send_security_request = 0x020231ff;
sm_set_accepted_stk_generation_methods = 0x02023225;
sm_set_authentication_requirements = 0x02023231;
sm_set_encryption_key_size_range = 0x02023241;
sm_set_key_distribution_flags = 0x0202324d;
sm_set_persistent_irk = 0x02023259;
sscanf_bd_addr = 0x020235ad;
sysSetPublicDeviceAddr = 0x02023b85;
uuid128_to_str = 0x02024449;
uuid_add_bluetooth_prefix = 0x020244a1;
uuid_has_bluetooth_prefix = 0x020244c1;
